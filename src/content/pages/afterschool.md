...
hero_image: /images/uploads/header-afterschool.png
...
ateliere_items:
  - name: Limbă germană
    icon: 🇩🇪
    description: Introducere în limba germană prin joc și activități interactive.
  - name: Club de lectură
    icon: 📚
    description: Explorăm poveștile împreună și dezvoltăm dragostea pentru cărți.
  - name: Dans
    icon: 💃
    description: Mișcare, ritm și bucurie pe muzică frumoasă.
  - name: Actorie
    icon: 🎭
...
echipa_text: >+
  ...
  🤖 Ruxandra Dragomir - Coordonator educațional program afterschool –
   Bună! Eu sunt Ruxandra. Sunt licențiată a Facultății de Filologie, specializarea română-engleză,  absolventă a programului masteral Management educațional și integrare europeană și absolventă a modulului psiho-pedagogic din cadrul UPG Ploiești.
  Predau din 2015 și am interacționat cu juniori de toate vârstele (grădiniță, școală primară, școală gimnazială și liceu). 
  ...
  ☕ Mirela Codreanu - Manager și fondator Cofferino Hub - Bună! Eu sunt Mirela și sunt mamă a doi copii de 3 și de 6 ani. La fel ca tine știu cât de dificil este să ne regăsim ritmul. Ne dorim să ieșim singuri, dar ne este dor și de fălcuțele care ne așteaptă nerăbdătoare. 

  De aceea am creat acest spațiu. Un loc unde poți lucra câteva minute neîntrerupt în timp ce copilul se joacă, unde poți deschide o carte pe care nu trebuie să o citești cu voce tare, unde poți bea o cafea bună în timp ce copilul participă la un curs sau un loc unde îl poți aduce liniștit după școală pentru ca o echipă pregătită și dedicată să se ocupe de nevoile juniorului.

  Este locul creat special pentru momente minunate împreună cu cel mic, separat sau împreună.

  Din dorința de a aduce plus valoarea timpului petrecut de copii după scoală, am decis să creem COFFERINO AFTERSCHOOL. Aici cei mici vor găsi echilibrul dintre confortul de acasă, joacă liberă si activitățile educaționale. 
  ...
  🎭Voicu - Actor la Teatru Ion Creangă și fondator Teatrul din Podul meu - Voicu este cel care ne face zilele mai colorate și mai interesante. El pregateste lecturi si discutii interesante din trecut si ne aduce spectacole și ateliere interactive, educative si pline de haz pentru copii.
